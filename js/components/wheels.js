export function renderScoreWheel(label, value) {
  ...
  // circumference = 2πr, r=70 so circumference ≈ 439.82
  ...
  return `
    <div class="score-wheel">
      ...
      <div class="wheel-container">
        <svg class="wheel-svg" viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <circle class="wheel-circle-bg" cx="70" cy="70" r="70" />
          <circle class="wheel-circle-fill" cx="70" cy="70" r="70" data-offset="${offset}" />
        </svg>
